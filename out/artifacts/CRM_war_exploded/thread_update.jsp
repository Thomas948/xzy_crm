            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 线索 - 更新线索 </span>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" action="ThreadUpdateServlet" method="post">
                            <!-- 更新线索ID-->
                            <input type="hidden" value="${customer.customerId}" name="customerId"/>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="customerName">线索名称</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="sources">线索来源</label>
                                <div class="col-md-4">
