      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title"> 客户 - 客户列表 </span>
          </div>
			  ...
			  <div class="card-toolbar clearfix">
				<form class="pull-right search-bar" method="get" action="#!" role="form" onsubmit="return false">
				  <div class="input-group">
                      <label>
                          <input type="text" id="keyword" class="form-control" value="" name="keyword" placeholder="请输入客户名称">
                      </label>
				...
				<div class="toolbar-btn-action">
				  <a class="btn btn-primary m-r-5" href="CustomerAddJumpServlet"><i class="mdi mdi-plus"></i> 新增</a>
				  <a class="btn btn-info m-r-5" href="ExcelCustomerDownLoadServlet"><i class="mdi mdi-check"></i> 导出</a>
...
<script type="text/javascript">
	...
	function getData(pageNo,pageSize,hasPre,hasNext) {
		...
		$.getJSON("CustomerGetPageServlet",{pageNo:pageNo,pageSize:pageSize,flag:1,keyword:keyword},function (d) {
			pageNo = d.pageNo;
			pageSize = d.pageSize;
			...
			for (let i = 0; i < list.length; i++) {
				content += "<tr>\n" +
						...
						"<td>\n" +
						"<div class='btn-group'>\n" +
						"<a class='btn btn-xs btn-default' href='CustomerUpdateJumpServlet?customerId="+list[i].customerId+"' title='编辑' data-toggle='tooltip'><i class='mdi mdi-pencil'></i></a>\n" +
						"<a class='btn btn-xs btn-default' href='CustomerDeleteServlet?customerId="+list[i].customerId+"' title='删除' data-toggle='tooltip'><i class='mdi mdi-window-close'></i></a>\n" +
						"</div>\n" +
						"</td>\n" +
						"</tr>";
			}
            ...
            if (confirm("确定要删除吗?")) {
                ...
                for(var i=0;i<cks.length;i++){
                   /* console.log(cks[i].value);*/
                    ...
                    if (i == cks.length - 1) {
                        window.location.href="CustomerToListServlet";
                    }
                }
            }
